...
var Icon$I = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/farms.png' : '/images/egg/farms.png' })));
};


var Icon$J = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/referral.png' : '/images/egg/referral.png' })));
};

var Icon$BSC = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/binance.png' : '/images/egg/binance.png' })));
};

var Icon$POLYGON = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/polygon.png' : '/images/egg/polygon.png' })));
};



var Icon$13 = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/graph.png' : '/images/egg/graph.png' })));
};
...
var Logo = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 239 26" }, props),
        React.createElement("image", { width: "239", height: "26", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewDark.png' })));
};
...
var Icon$T = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/pools.png' : '/images/egg/pools.png' })));
};

var Icon$github = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React.createElement("image", { width: "512", height: "512", href: isDark ? '/images/egg/github.png' : '/images/egg/github.png' })));
};
...
var Panel = function (props) {
  ...
  /*  React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://rugdoc.io/project/spaceportdefi-2nd-exploration/" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { primaryBright: "#d0d0d0",background: "#FAF9FA", backgroundDisabled: "#E9EAEB",
 contrast: "#575154", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#15e7f4", textDisabled: "#BDC2C4", textSubtle: "#575154",
  borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
...
text: "#15e7f4", textDisabled: "#666171", textSubtle: "#ffffff", borderColor: "#524B63", card: "rgba(21, 32, 38, 0.5)", gradients: {
